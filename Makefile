files = juno/entity.cc juno/facet.cc juno/transform.cc main.cc juno/facet_id.cc juno/flow.cc juno/platform/sdl_window.cc juno/ui/ui.cc juno/platform/sdl_wrapper.cc
...
incl = -I include/glm -I libs/SDL2.framework/Headers -I include/imgui -I include/imgui/backends -framework OpenGL
